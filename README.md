...
* Реализованы две модели: модель самого поста, которая включает в себя header, author_name, e.t.c, и модель поста, который нужно будет отскрейпить, включающий два поля:
